...
class ClientApproveShiftsSchedulingPage extends StatefulWidget {
  ...
  const ClientApproveShiftsSchedulingPage({super.key, required this.args});

  @override
  State<ClientApproveShiftsSchedulingPage> createState() =>
      _ClientApproveShiftsSchedulingPageState();
}
...
class _ClientApproveShiftsSchedulingPageState
  ...
  Future<List<Map<String, dynamic>>> getAllItems() async {
    List<Map<String, dynamic>>? allItemsTemp =
        await clw.getWorkOrderCampaignsAcceptedShifts(clientId!, startWorkDay!);
    return allItemsTemp!;
  }
  ...
  void onButtonPressed(Map<String, dynamic> item, BuildContext ctx) async {
    ...
    try {
      ...
      if (item['actionType'] == 'Approve') {
        ...
        String? shiftApprover;
        if (clientUser != null) {
          shiftApprover = clientUser!.firstName + ' ' + clientUser!.lastName;
        } else {
          shiftApprover = 'Unknown';
        }
              ...
              return Center(
                child: Padding(
                  ...
                  child: Container(
                    ...
                    width: screenWidth - 10,
                    child: Text(
                        'There are no mobile accepted shifts for this client.',
                ...
                return Center(
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      width: screenWidth - 10,
                      child: Text(
                          'There are no accepted mobile shifts for this client.',
                          style: TextStyle(
                              fontSize: Theme.of(context)
                                      .textTheme
                                      .headlineMedium!
