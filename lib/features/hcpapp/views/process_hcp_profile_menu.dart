...
class ProcessHCPProfileMenu extends StatefulWidget {
  ...
  @override
  _ProcessHCPProfileMenuState createState() => _ProcessHCPProfileMenuState();
}

class _ProcessHCPProfileMenuState extends State<ProcessHCPProfileMenu> {
...
//  GlobalKey<ScaffoldState> _key = new GlobalKey<ScaffoldState>();
  ...
  List<Map<String, dynamic>> hcpSchedulingMenus = [
    ...
    {
      "menuId": 4,
      "menuName": "List of Confirmed Shifts Shifts",
