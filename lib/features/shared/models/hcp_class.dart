...
class HCPClass {
  ...
  HCPClass.fromJson(Map<String, dynamic> json)
      : hcpId = json['hcpId'] as int,
        ...
        credWillWarnDate = json['credWillWarnDate'],
  ...
  Map<String, dynamic> toJson() => {
        ...
        'credsWillWarnDate': credWillWarnDate,
...
//      'payRate': payRate,
  ...
  HCPClass copyWith(
    ...
    return HCPClass(
        ...
        credWillWarnDate ?? this.credWillWarnDate,
