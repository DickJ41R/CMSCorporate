...
// class ChartPresentation extends StatefulWidget {
//
//
//   const ChartPresentation ({super.key});
//
//   @override
//   State<ChartPresentation> createState() => _ChartPresentationState();
// }
//
// class _ChartPresentationState extends State<ChartPresentation> {
//
//   _ChartPresentationState();
//
...
//         appBar: AppBar(
//             title: const Text(
//               'Menu for Loading Client Data',
//               style: TextStyle(
//                 color: Colors.white,
//               ),
//             ),
//             backgroundColor: const Color.fromARGB(255, 13, 125, 103)),
//           body: _buildDashedLineChart()
//     );
//   }
...
//             color: Colors.white),
//           text: _isCardView ? '' : getTitle(),
//       ),
//       legend: Legend(
//           isVisible: _isCardView ? false : true,
